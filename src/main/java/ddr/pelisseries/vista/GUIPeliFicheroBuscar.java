 ...
 * @author Usuario
 */
public class GUIPeliFicheroBuscar extends javax.swing.JFrame {
    ...
    public GUIPeliFicheroBuscar(String peliFichero, String peliFecha) {
        initComponents();
        this.setLocationRelativeTo(null);
        jListBuscarPelisEcontradas.setModel(encontradas);
        jTextBuscarPeliFichero.setText(peliFichero);
        fechaPeli = peliFecha;
        
        
        encontradas.clear();        
        String peliBuscada = jTextBuscarPeliFichero.getText(); //almacenamos en variable el título de la peli
...
//                        System.out.println(peliencontrada.getUrlPoster());
    ...
    private void initComponents() {
        ...
        jTextBuscarPeliFichero = new javax.swing.JTextField();
        ...
        jTextBuscarPeliFichero.setEnabled(false);
        ...
        BotonBuscarNuevaPeli.setText("Añadir Peli Vista");
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(jTextBuscarPeliFichero, javax.swing.GroupLayout.PREFERRED_SIZE, 416, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jTextBuscarPeliFichero, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void BotonBuscarNuevaPeliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonBuscarNuevaPeliActionPerformed
        ...
        GUINuevaPeliFichero nu = new GUINuevaPeliFichero(peliSeleccionada, estreno, fechaPeli);
        nu.setVisible(true);
    ...
    private void jListBuscarPelisEcontradasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jListBuscarPelisEcontradasMouseClicked
        ...
        try {
            ...
            Logger.getLogger(GUIPeliFicheroBuscar.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIPeliFicheroBuscar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new GUIPeliFicheroBuscar().setVisible(true);
        });
    }
    ...
    private javax.swing.JTextField jTextBuscarPeliFichero;
